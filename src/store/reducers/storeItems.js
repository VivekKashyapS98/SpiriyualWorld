...
/*
As this site doenst have a backend, the data is fetched from the Redux Store.
More books can be appended into the 'book' array in the ITEM object.
*/
const ITEMS = {
  books: [
    {
    ...
    },
    {
      ...
      author: "A.C. Bhaktivedanta Swami Prabhupada",
      info:
        "Srimad-Bhagavatam begins with the definition of the ultimate source. It is a bona fide commentary on the Vedanta-sutra by the same author, Srila Vyasadeva, and gradually it develops into nine cantos up to the highest state of God realization.",
    ...
    },
    {
      ...
      image:
        "https://images-na.ssl-images-amazon.com/images/I/510K81A5YPL._SX310_BO1,204,203,200_.jpg",
      price: 10,
    },
    {
      id: 4,
      ...
      image:
        "https://krishna.org/wp-content/uploads/2012/12/Sri-Isopanisad-scans-of-original-1969-edition-1-199x300.jpg",
      price: 10,
    },
    {
      id: 5,
      ...
      image:
        "https://krishna.org/wp-content/uploads/2013/01/Raja-Vidya_The_King_of_Knowledge-Original_1973_book_SCAN-1-179x300.jpg",
      price: 10,
    },
    {
      id: 6,
      ...
      image:
        "https://krishna.org/wp-content/uploads/2013/01/Beyond_Birth_and_Death-Original_1974_edition_scan-1-181x300.jpg",
      price: 10,
    },
    {
      id: 7,
    ...
    },
    {
      ...
      image:
        "https://images-na.ssl-images-amazon.com/images/I/61bceaOh6bL._SX329_BO1,204,203,200_.jpg",
      price: 25,
    },
    {
      id: 9,
      ...
      author: "Sri Shankaracharya(Translation: Swami Gambhirananda)",
      info:
        "The essence of the knowledge of the Vedas is called Vedanta, which comprises the Upanishads. Freedom, physical, mental, and spiritual - these are the watchwords of the Upanishads.",
      image:
        "https://images-na.ssl-images-amazon.com/images/I/41eWIApmcVL._SX313_BO1,204,203,200_.jpg",
      price: 25,
    },
    {
      id: 10,
      ...
      image:
        "https://images-na.ssl-images-amazon.com/images/I/417nHRNXq4L._SX311_BO1,204,203,200_.jpg",
      price: 10,
    },
  ],
};
